          ...
          <div class="row">
            <div class="col-md-12 col-lg-3">
              <div class="row txtRow">
                <input class="form-control form-control-lg txtSearch" v-model="searchAgentName" type="text" placeholder="enter brand specialist last name" @keyup.enter="searchAgent">
              </div>
              <div class="row searchRow mt-3 mb-1 text-right pr-0">
                <div class="float-right w-100" >
                  <div class="lblSearch agentStatusLabel inlineDisplay pt-1 pr-3">Active Brand Specialist</div>
              ...
              <div class="row buttonRow mt-3 mb-3">
                <button class="btnSearch btn" @click="newAgent" >New Brand Specialist</button>
              </div>
              <!-- End Search -->
            </div>
                  ...
                  <transition name="fadeMain" v-for="agent in agents" :key="'agent' + agent.id">
                    <div class="listItem col-md-12 d-flex" @click="showAgentInfo(agent.id, agent.branch_name)">
                      ...
                      <span class="col-8 col-lg-6">
                        ...
                        <span class="listDescription hideLg mt-1"><span class="hiddenNextLine"><br /></span>{{ agent.branch_name }}</span>
                      </span>
                      <span class="col-0 col-lg-4 hiddenOnSmallDesc">
                        <span class="">{{ agent.branch_name }}</span>
                      </span>
            ...
            <h5 class="card-header bg-white">
              ...
              <div class="btn-group float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <button class="dropdown-item clickable" type="button" @click="promoteAgent" v-show="agentStatus && admin">Promote Brand Specialist</button>
...
export default {
  ...
  methods: {
    ...
    searchAgent () {
      ...
      let self = this
      axios.post('api/agent/search', data).then(response => {
        if(response.data.status === 'success'){
    ...
    editAgent () {
      ...
      this.$auth.setPic1(this.selected.image_file_name)
      ...
      this.$auth.setPic2(this.selected.psa_file_name)
      ...
      this.$auth.setPic3(this.selected.nbi_file_name)
      ...
      localStorage.uplphilhealth = this.selected.phil_health_file
      localStorage.allowance = this.selected.allowance
      localStorage.isTLEditing = '0'
